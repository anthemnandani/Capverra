...
import { TrendingUp, TrendingDown, User, Building2, Shield } from "lucide-react"

// ── Types ─────────────────────────────────────────────────────────────────────
type Currency = "USD" | "EUR" | "GBP" | "ZAR" | "CHF" | "JPY" | "AUD" | "CAD"
type OwnerType = "Individual" | "LLC" | "Trust" | string
...
export function AssetsTable() {
  ...
  // Inline update — PATCH to API then update local state
  ...
  const tableHeaders = [
    "Asset Name", "Type", "Owner", "Location", "Currency",
    "Purchase Value", "Purchase Date", "Latest Valuation", "Valuation Date", "Performance", "Actions",
  ]
