      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        {isLoading ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-11 w-11 rounded-full outline-none">
              ...
              <DropdownMenuContent className="w-[80vw] max-w-sm rounded-xl" align="end" forceMount>
